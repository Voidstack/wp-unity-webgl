...
function unity_webgl_admin_page(): void
{
    ...
    <div style="display: flex; align-items: center;">
        ...
        <ul>
            ...
            echo '<tr><th style="text-align:left; border-bottom: 1px solid #ccc;">Name</th><th style="text-align:right; border-bottom: 1px solid #ccc;">Size (Mo)</th><th style="text-align:right; border-bottom: 1px solid #ccc;"></th></tr>';
            ...
            foreach ($builds as $build) {
                ...
                echo '<td style="padding: 8px 0; text-align:right;">' . $size_mb . '</td>';
