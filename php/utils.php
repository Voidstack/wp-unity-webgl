...
class Utils {
    ...
    public static function deleteFolder(string $dir): bool {
        if (!is_dir($dir)) {
            Utils::error(esc_html__( 'Not a valid directory', 'unity-webgl-integrator' ) . ' : ' . $dir);
            return false;
        }
        ...
        if (!$success) {
            Utils::error(esc_html__( 'Failed to delete directory', 'unity-webgl-integrator' ) . ' : ' . $dir);
        }
        return $success;
    }
    ...
    */
    ...
    public static function error(string $message): void {
        echo "<p style='color:red;'>❌ " . esc_html__( 'Error: ', 'unity-webgl-integrator' ) . wp_kses_post( $message ) . "</p>";
    }
    
    // Display an informational message in the WordPress admin interface
    public static function info(string $message): void {
        echo "<p style='color:black;'>ℹ️ " . esc_html__( 'Info: ', 'unity-webgl-integrator' ) . wp_kses_post( $message ) . "</p>";
    }

    // Display a validation message in the WordPress admin interface
    public static function valid(string $message): void {
        echo "<p style='color:green;'>✅ " . esc_html__( 'Success: ', 'unity-webgl-integrator' ) . wp_kses_post( $message ) . "</p>";
    }
}
